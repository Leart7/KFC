				...
				<div class="row">
							...
							<div class="card-body  p-0">
								<div class="table-responsive ">
										...
										<tr>
											<td>
												<div class="media align-items-center">
													<img class="me-3 img-fluid rounded-circle" width="75" src="images/card/pic1.jpg" alt="DexignZone">
													<div class="media-body">
									...
									<div class="card-footer border-0 pt-0 text-center">
										<a href="order-list.php" class="btn-link">View More &gt;&gt;</a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-xl-3 col-xxl-4 col-lg-4 col-sm-12">
						<div class="card">
							<div class="card-header border-0">
								<div>
									<h4 class="card-title mb-2">Trending Menus</h4>
								</div>
							</div>
