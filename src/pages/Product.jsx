...
import { useProduct } from "../feautures/productDetails/useProduct";
...
function Product() {
  ...
  return (
    <div className="mx-auto h-screen w-3/4">
      ...
      <div>
        <p className="unselectable mt-16 font-normal text-stone-950 underline underline-offset-[34px] hover:cursor-pointer">
          Description
        </p>
